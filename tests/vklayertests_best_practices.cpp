...
void VkBestPracticesLayerTest::InitBestPracticesFramework() {
    ...
    VkValidationFeatureDisableEXT disables[] = {
        ...
        VK_VALIDATION_FEATURE_DISABLE_API_PARAMETERS_EXT, VK_VALIDATION_FEATURE_DISABLE_OBJECT_LIFETIMES_EXT,
        VK_VALIDATION_FEATURE_DISABLE_CORE_CHECKS_EXT,    VK_VALIDATION_FEATURE_DISABLE_UNIQUE_HANDLES_EXT,
    };

    VkValidationFeaturesEXT features = {};
    features.sType = VK_STRUCTURE_TYPE_VALIDATION_FEATURES_EXT;
    features.enabledValidationFeatureCount = std::extent<decltype(enables)>::value;
    features.disabledValidationFeatureCount = std::extent<decltype(disables)>::value;
