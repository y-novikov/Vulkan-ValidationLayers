...
TEST_F(VkLayerTest, BufferDeviceAddressKHR) {
    ...
    if (m_device->props.apiVersion >= VK_API_VERSION_1_2) {
        auto fpGetDeviceMemoryOpaqueCaptureAddress = (PFN_vkGetDeviceMemoryOpaqueCaptureAddress)vk::GetDeviceProcAddr(device(), "vkGetDeviceMemoryOpaqueCaptureAddress");
...
TEST_F(VkLayerTest, BufferDeviceAddressKHRDisabled) {
    ...
    if (m_device->props.apiVersion >= VK_API_VERSION_1_2) {
        auto fpGetBufferOpaqueCaptureAddress = (PFN_vkGetBufferOpaqueCaptureAddress)vk::GetDeviceProcAddr(device(), "vkGetBufferOpaqueCaptureAddress");
